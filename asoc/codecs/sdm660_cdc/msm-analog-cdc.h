...
extern void set_ex_spk_pa_gpio(int gpio);
extern void ex_spk_pa_lock_init(void);
#endif

#if IS_ENABLED(CONFIG_AUDIO_FM_LNA_EN)
extern void set_fm_lna_en_gpio(int gpio);
extern int msm8x16_fm_lna_power_switch(struct snd_soc_card *card, bool on);
#endif
